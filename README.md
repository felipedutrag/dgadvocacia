# ⚖️ DG Advocacia — Infraestrutura & Backend Jurídico B2B para Registro de Marcas no INPI
...
<p align="center">
  <strong>Ecossistema tecnológico e suporte jurídico especializado em Propriedade Industrial (INPI) para agências de branding, escritórios de contabilidade e empresas de marcas.</strong>
</p>
...
## ⚡ Pilares da Parceria Institucional

```
┌─────────────────────────┐          ┌─────────────────────────┐
│   EMPRESA PARCEIRA      │          │     DG ADVOCACIA        │
│   (Front-End Comercial) │ ◄──────► │  (Backend Operacional)  │
│                         │          │                         │
│ • Relacionamento Direto │          │ • Pareceres Técnicos    │
│ • Prospecção de Clientes│          │ • Protocolo no e-Marcas │
│ • Gestão de Contratos   │          │ • Radar RPI Semanal     │
│ • Precificação Própria  │          │ • Oposições & Recursos  │
└─────────────────────────┘          └─────────────────────────┘
```
...
## 📊 Dashboard & Telemetria do Parceiro
...
## 🛡️ Esteira Operacional de Blindagem (4 Fases)

```
[01. Triagem & Raio-X IA] ──► [02. Depósito Oficial] ──► [03. Vigilância na RPI] ──► [04. Certificado Decenal]
  (Busca Nice / Viena)         (e-Marcas / Protocolo)       (Radar de Colidência)         (Ativo Blindado 10 Anos)
```

1. **Fase Prévia — Triagem & Raio-X IA:** Varredura fonética profunda, enquadramento nas 45 classes de Nice e parecer de registrabilidade.
2. **Protocolo — Depósito Oficial:** Peticionamento formal no sistema eletrônico do INPI com emissão de GRUs e fixação de Prioridade Unionista.
3. **Vigilância — Radar RPI & Defesa Ativa:** Varredura a cada edição da Revista da Propriedade Industrial com atuação técnica tempestiva.
4. **Ativo Blindado — Concessão Decenal:** Acompanhamento do exame de mérito, deferimento e emissão do Certificado de Registro válido por 10 anos em todo o território nacional.
...
│  (Parceiros & Contas)   │          │  (Carteira de Pedidos)  │          │  (Radar RPI & Despachos)│
└────────────┬────────────┘          └────────────▲────────────┘          └─────────────────────────┘
             │                                    │
             │                                    │ (FK auth.users)
             ▼                                    │
...
## ⚖️ Conformidade Ética & Blindagem OAB

A plataforma da DG Advocacia é rigorosamente construída em conformidade com:

- **Estatuto da Advocacia e da OAB (Lei Federal nº 8.906/1994)**
- **Código de Ética e Disciplina da OAB (CED/OAB)**
- **Provimento CFOAB nº 205/2021 (Publicidade e Marketing Jurídico)**

> **Diretrizes Asseguradas:** Vedação à mercantilização, ausência de promessa de resultado (obrigação de meio com foco em rigor técnico), proteção ao sigilo profissional inviolável das marcas pesquisadas e assinatura privativa por advogado habilitado em todos os atos perante o INPI.
...
GGPIX_BEARER_TOKEN=seu-token-bearer
