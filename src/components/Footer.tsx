export default function Footer() {
  ...
  return (
    <footer className="bg-[#070A11] border-t border-accent/10 pt-16 pb-12 text-gray-400 text-sm relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-12 mb-12">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <div className="pt-1">
              <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-[11px] font-medium bg-accent/10 text-accent border border-accent/20">
          ...
          <div className="md:col-span-3">
            <h4 className="text-white font-semibold text-xs uppercase tracking-[0.2em] mb-4 text-accent/90">
              Navegação
            </h4>
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <ul className="space-y-3 text-xs sm:text-sm">
              <li>
                ...
                >
                  <div className="w-7 h-7 rounded-lg bg-accent/10 border border-accent/20 flex items-center justify-center text-accent shrink-0 group-hover:border-accent/40 transition-colors">
        ...
        {/* Divider & Bottom Bar */}
        <div className="border-t border-accent/10 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-left text-xs text-gray-500">
          <div>
          ...
          <div className="flex items-center gap-4 text-gray-400">
            <span className="text-[11px] text-gray-500">Direito Digital &bull; IA &bull; Propriedade Intelectual</span>
          </div>
        </div>
      </div>
    </footer>
